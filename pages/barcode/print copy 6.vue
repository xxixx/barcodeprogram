<template>
  ...
  processCode{{ processCode }} -->
      ...
      <div class="container d-flex flex-wrap mt-4">
        ...
        >
        <!--  -->
       <div class="barcode-position ms-2 mt-3">
        <div class="d-flex flex-row mt-3 justify-content-between ">
            <div class="d-flex flex-column mt-1">
              <span class=" align-items-center" style="font-size: 6px"
                  >ALKOSC</span
                >
            ...
            <div class="d-flex flex-column mt-1 ms-2">
              <span style="font-size: 0.5em">{{ productName }}</span>
              <span class="mt-2" style="font-size: 0.5em">{{ location }}</span>
            </div>
            
           
            <div class="d-flex justify-content-between">
              <!-- <span class="mx-2 position-b align-items-center border-bottom" style="font-size: 5px">{{ barcode }}</span> -->
          ...
          <!-- <div class="m-0 p-0">
            <span class="mx-2 align-items-center border-bottom" style="font-size: 5px">{{ barcode }}</span>
          </div> -->
       </div>
         <!--  -->
        </div>
