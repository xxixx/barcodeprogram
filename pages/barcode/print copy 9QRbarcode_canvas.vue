          ...
          <div class="d-flex flex-column barcode-position" style="text-align: center;">
            ...
            <div class="d-flex justify-content-between center-div">
              <div class="d-flex flex-column">
                <span class="top-gap"></span><span>VINFAST</span><span>{{ carName }}</span>
              </div>
              <div class="qr-code">
                <QRCode class="mx-2" :text="barcode" :size="102" />
              </div>
              <div class="d-flex flex-column">
                <span class="top-gap"></span><span class="middle-font">&nbsp;CAB</span><span class="small-font">VN/EU</span>
              </div>
            </div>
